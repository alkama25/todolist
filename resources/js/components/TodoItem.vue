...
const markAsComplete = async (event: Event) => {
    checked.value = (event.target as HTMLInputElement).checked;
    await store.markAsComplete(Number(checked.value), props.listItem.id);
};
const deleteTodo = async () => await store.deleteTodo(props.listItem.id);
</script>
